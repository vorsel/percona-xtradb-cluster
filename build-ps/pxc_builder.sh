...
echo "DESTINATION=${DESTINATION}" >> ${WORKDIR}/pxc-57.properties
...
rsync -av ${WORKDIR}/percona-xtradb-cluster/extra/coredumper/ ${PXCDIR}/extra/coredumper --exclude .git || true
...
MYSQL_RELEASE=3
WSREP_VERSION=31.49
PRODUCT_FULL=Percona-XtraDB-Cluster-5.7.33-31.49
